        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <section id="contact">
            ...
            <div className="flex flex-col lg:flex-row gap-12">
              ...
              {/* Contact Form */}
              <form
                className="lg:w-1/2 w-full bg-white p-8 shadow-lg rounded-lg border border-gray-200"
                data-aos="fade-down"
              >
            ...
            <div className=" border-t-4 border-gray-200 flex max-md:flex-col gap-5 justify-between items-center px-4 mt-10 py-8 text-center text-sm text-gray-400">
              <p>© 2025. All Right Preserved</p>
